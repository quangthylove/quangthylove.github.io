...
$player = '<link href="/phim/video-js.min.css" rel="stylesheet">
		<script src="/phim/jquery.js"></script>
            <script src="/video/jquery-ui.js"></script>
		<script src="/get/admin.js"></script>
		<script src="/get/video-quality-selector.js"></script>
	
	<video id="playerayer" class="video-js hxplayer-skin" controls autoplay width="100%" height="100%" poster="" title="Bạn đang xem video trên Phimhaynhat.org" data-setup="{}">'.xvideos($url).'
